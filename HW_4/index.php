...
$works = [
	[
		"name" => "Воспитатель",
         "dateStart" => "Август 2019",
         "dateEnd" => "Текущее время",
         "specification" => "Обучение и воспитание детей дошкольного возраста, проведение занятий по программе детского сада, активное участие во всех мероприятиях детского сада, организация игровой и досуговой деятельности детей.",
	],
    [
    	"name" => "Помощник воспитателя",
      	"dateStart" => "Июль 2016",
      	"dateEnd" => "Август 2019",
      	"specification" => "Организация воспитания, ухода, присмотра и образования детей в соответствии с их возрастом и индивидуальными особенностями.",
  	],
  	[
    	"name" => "Помощник воспитателя",
      	"dateStart" => "Май 2014",
      	"dateEnd" => "Июль 2016",
      	"specification" => "Контроль за состоянием и укреплением здоровья каждого ребенка. Поддержание чистоты и порядка. Общение с родителями.",
  	],
];
?>
<!DOCTYPE html>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal">
            	...
            	<p><?php echo $works[$i]["specification"];?></p>
            	<hr>
          </div>
          <?php endfor;?>
